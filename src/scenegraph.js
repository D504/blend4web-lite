...
exports.create_rendering_graph = function(sc_render, cam_scene_data,
    ...
    for (var i = 0; i < curr_level.length; i++) {
        ...
        case m_subs.SKY:
            ...
            if (sky_reflect_links.length) {
                // m_graph.append_edge_attr(graph, subs, subs_main_opaque, sky_reflect_links[0]);
                // if (subs_main_blend)
                //     m_graph.append_edge_attr(graph, subs, subs_main_blend, sky_reflect_links[0]);
                // if (subs_main_glow)
                //     m_graph.append_edge_attr(graph, subs, subs_main_glow, sky_reflect_links[0]);
                // if (subs_main_xray)
                //     m_graph.append_edge_attr(graph, subs, subs_main_xray, sky_reflect_links[0]);

                // if (subs_main_blend)
                //     m_graph.append_edge_attr(graph, subs_irradiance, subs_main_blend, sky_reflect_links[0]);
                // if (subs_main_glow)
                //     m_graph.append_edge_attr(graph, subs_irradiance, subs_main_glow, sky_reflect_links[0]);
                // if (subs_main_xray)
                //     m_graph.append_edge_attr(graph, subs_irradiance, subs_main_xray, sky_reflect_links[0]);
            }
            break;
